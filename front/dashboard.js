...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function fetchDashboardData() {
        try {
            ...
            const response = await fetch('http://52.206.27.51:5001/api/dashboard'); // Your Flask dashboard endpoint
    ...
    async function enrollInCourse(courseId) {
        ...
        try {
            const response = await fetch('http://52.206.27.51:5001/api/enroll', { // Your Flask enroll endpoint
                method: 'POST',
                headers: {
    ...
    if (logoutButton) {
        logoutButton.addEventListener('click', async () => {
            ...
            try {
                ...
                await fetch('http://52.206.27.51:5001/api/logout', { method: 'POST' });
            } catch (error) {
